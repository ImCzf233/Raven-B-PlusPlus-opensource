...
public class ShiftTap extends Module
{
    ...
    public ShiftTap() {
        ...
        this.registerSetting(this.dynamic = new TickSetting("Dynamic wait time", false));
    ...
    public void wTap() {
        ...
        if (ShiftTap.mc.field_71439_g.func_70032_d(this.target) > this.range.getInput() || (this.onlyPlayers.isToggled() && !(this.target instanceof EntityPlayer)) || (this.onlySword.isToggled() && !Utils.Player.isPlayerHoldingSword()) || this.rhit < this.hits) {
            return;
        }
        this.trystartCombo();
    }
    ...
    public void finishCombo() {
        this.state = WtapState.NONE;
        KeyBinding.func_74510_a(ShiftTap.mc.field_71474_y.field_74311_E.func_151463_i(), false);
        this.hits = 0;
    ...
    public void startCombo() {
        ...
        KeyBinding.func_74510_a(ShiftTap.mc.field_71474_y.field_74311_E.func_151463_i(), true);
        ...
        if (this.dynamic.isToggled()) {
            cd = ((3.0f - ShiftTap.mc.field_71439_g.func_70032_d(this.target) < 3.0f) ? (cd + (3.0 - ShiftTap.mc.field_71439_g.func_70032_d(this.target) * this.tapMultiplier.getInput() * 10.0)) : cd);
        }
